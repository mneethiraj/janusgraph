...
@Table(name = "janus_key",
       ...
       uniqueConstraints = {@UniqueConstraint(name = "janus_key_uk_name", columnNames = {"store_id", "name"})})
public class JanusKey implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "janus_key_seq", sequenceName = "janus_key_seq", allocationSize = 1)
